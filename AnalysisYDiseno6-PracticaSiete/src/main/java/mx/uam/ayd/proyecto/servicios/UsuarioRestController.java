...
public class UsuarioRestController {
	...
	public ResponseEntity<UsuarioDto> retrieve(@PathVariable("id") Long id) {
		try {
			UsuarioDto usuario = servicioUsuarios.recuperarUsuario(id);
	...
	public ResponseEntity<UsuarioDto> delete(@PathVariable("id") Long id) {
		try {
			UsuarioDto usuario = servicioUsuarios.eliminarUsuario(id);
	...
	public ResponseEntity<UsuarioDto> modify(@PathVariable("id") Long id, @RequestBody UsuarioDto usuario) {
		try {
			UsuarioDto usuarioActualizado = servicioUsuarios.actualizarUsuario(id, usuario);
